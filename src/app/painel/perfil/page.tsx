    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Seus dados de cadastro e suas habilidades (treinamentos e provas) na BMC Academy.
        </p>
      </div>
      ...
      <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/5">
        ...
        <p className="mt-4 text-xs text-gray-400">
          Encontrou algum dado errado ou desatualizado? Fale com um administrador para corrigir.
        </p>
      </div>
      ...
      <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/5">
        <h2 className="mb-4 text-lg font-semibold text-foreground">
          Minhas habilidades (treinamentos e provas)
        </h2>
